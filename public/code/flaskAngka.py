...
@app.route('/predictCNNAngka')

def index_predictCNN():       
    # nmFile ='F:\\KULIAH ITS PUTRI\\SEMESTER 8 (2021)\\TUGAS AKHIR\\TA Putri\\predictHuruf\\coba_predict1.png'
    ...
    mapClass = 'C:\\xampp\\htdocs\\welearn_web\\public\\code\\maps.npz'
    ...
    nmModel  = ('C:\\xampp\\htdocs\\welearn_web\\public\\code\\modelCNNAngka.h5')
    ...
    if os.path.exists(nmModel):             
        ...
        pred     = model(img)
        idxAngka = np.argmax(pred)
        
        # print("prediksi %s"%mapHuruf[idxHuruf])
        return mapAngka[idxAngka]
