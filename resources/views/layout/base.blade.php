                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full content-side-user px-10 align-parent">
                        ...
                        <div class="sidebar-mini-hidden-b text-center">
                            ...
                            <li class="list-inline-item">
                                    <a class="font-size-l text-dual-primary-dark" style="font-size: 7px;" href="be_pages_generic_profile.html">Practice more, Good result</a>
                                    <!-- <span class="font-size-xl text-dual-primary-dark" style="font-size: 15px;">Welearn</span><span class="font-size-xl text-primary"> Website</span> -->
                                </li>
            </ul>
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li>
                                <a href="{{url('home')}}" ><i class="fa fa-bar-chart"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                            </li>
                            <li>
                    ...
                    <div class="content-header-section">
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <!-- <span class="d-none d-sm-inline-block"></span>  etok etok-->
